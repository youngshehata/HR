        ...
        <main class="agazaMainContainer">
          ...
          <section class="bodySection">
            ...
            <h3 class="letterItself">
              Kindly accept vacation for our employee
              <span class="coloredSpan">${data.name}</span> <br />
              As he/she still has ${data.remaining} days left of his/her leave balance
            </h3>
            ...
            <br />
            <br />
            <h2 style="text-align: center">CEO Signature:</h2>
